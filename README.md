...
Once the `conda-forge` channel has been enabled, `fps-jupyterlab` can be installed with:

```
conda install fps-jupyterlab
```

It is possible to list all of the versions of `fps-jupyterlab` available on your platform with:
